...
export const tournaments = pgTable("tournaments", {
  ...
  eventDirectorName: text("event_director_name"),
  eventDirectorEmail: text("event_director_email"),
  eventDirectorPhone: text("event_director_phone"),
  eventRulesText: text("event_rules_text"),
  eventRulesUrl: text("event_rules_url"),
  eventYoutubeUrl: text("event_youtube_url"),
  eventGalleryImages: jsonb("event_gallery_images").$type<string[]>(),
  ...
  eventFoodAndDrinksInfo: text("event_food_and_drinks_info"),
  ...
  sponsorPagesEnabled: boolean("sponsor_pages_enabled").notNull().default(false),
});
...
// Tournament sponsors - sponsor cards shown to players on join
export const tournamentSponsors = pgTable("tournament_sponsors", {
  id: serial("id").primaryKey(),
  tournamentId: integer("tournament_id").notNull().references(() => tournaments.id, { onDelete: "cascade" }),
  sponsorName: text("sponsor_name").notNull(),
  donationType: text("donation_type"), // e.g. "Gold Sponsor", "Hole Sponsor", "Prize Donor"
  blurb: text("blurb"),
